...
const orderIcecream = async function() {
    try {
        ...
        orderResult.style.visibility = 'visible';
        greetCustomer.innerText= `Please enter required info`;
        orderResult.append(greetCustomer);
    }
}
...
function resetOrder(){
    ...
    scoop.style.visibility = 'hidden';
    topping.style.visibility = 'hidden';
    customerName.value = '';
    preparingTopping.innerText= '';
    greetCustomer.innerText= '';
    customerFlavourChoice.innerText= '';
    preparingScoop.innerText= '';
    customerToppingChoice.innerText = '';
    orderComplete.innerText= ''
}
